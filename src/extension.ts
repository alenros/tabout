...
import { selectNextCharacter, returnHighest, returnLowest, oneNumberIsNegative, getPreviousChar, getNextChar, determineNextSpecialCharPosition, selectPreviousCharacter, determinePreviousSpecialCharPosition } from './utils';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    let tabBack = vscode.commands.registerCommand('tabback', () => {
        ...
        if (characterInfo !== undefined) {
            ...
            if (positionPreviousSpecialCharacter > -1) {
                //Move cursor
                let nextCursorPosition = new vscode.Position(editor.selection.active.line, positionPreviousSpecialCharacter);
    ...
    context.subscriptions.push(tabBack);
